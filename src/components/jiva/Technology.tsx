...
const Technology = () => {
  ...
  return (
    <section
      id="technology"
      ref={ref}
      className="fade-in-section bg-soil py-20 sm:py-28 px-4 sm:px-6"
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          {/* The Stack */}
          <div>
            <h3 className="font-cormorant text-cream text-xl font-semibold mb-6">
              The Stack
            </h3>
            <div className="flex flex-col gap-3">
              {stack.map((item, i) => (
                <div key={i} className="flex items-center gap-3">
                  ...
                  <span className="font-mono-dm text-cream text-sm">
                    {item}
                  </span>
                </div>
              ))}
            ...
            <div className="flex flex-col gap-3">
              {principles.map((item, i) => (
                <div key={i} className="flex items-center gap-3">
                  <svg
                    viewBox="0 0 20 20"
                    className="w-5 h-5 text-leaf flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                  >
                  ...
                  <span className="font-source-serif text-cream text-sm">
                    {item}
                  </span>
                </div>
              ))}
