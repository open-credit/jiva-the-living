...
const Vision = () => {
  ...
  return (
    <section id="vision" ref={ref} className="fade-in-section bg-earth py-20 sm:py-28 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <p className="font-source-serif text-cream text-lg sm:text-xl leading-relaxed text-center mb-10">
          Jiva begins with poultry because it's the most accessible entry point — 3 hens, ₹500, no land
          required. But the architecture is universal. Every biological asset that produces measurable
          economic activity can become a credit instrument. Every cooperative can become a bank.
          <br /><br />
        ...
        <p className="font-source-serif text-parchment text-base text-center leading-relaxed mb-12">
          From 500 households to 190 million. From poultry to the full bio-capital stack. From village
          cooperatives to India's first indigenous digital bank.
        </p>
